...
def run_apidoc(_):
    ...
    argv = ["-f", "-e", "-o", "source", "--separate", "../pytexit"]
...
latex_documents = [
    (master_doc, "pytexit.tex", "pytexit Documentation", "Erwan Pannier", "manual"),
]
...
man_pages = [(master_doc, "pytexit", "pytexit Documentation", [author], 1)]
